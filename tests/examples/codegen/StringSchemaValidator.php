 ...
 *
 *
 * @generated SignedSource<<38e09231d6f92e2815833ec668992cb8>>
 */
...
final class StringSchemaValidatorPropertiesHackEnum {
...
final class StringSchemaValidator
  ...
  public static function check(
    ...
    if (\HH\Lib\C\contains_key($typed, 'hack_enum')) {
      try {
        $output['hack_enum'] = StringSchemaValidatorPropertiesHackEnum::check(
          $typed['hack_enum'],
  ...
  <<__Override>>
  protected function process(): TStringSchemaValidator {
